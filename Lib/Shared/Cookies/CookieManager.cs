...
namespace Blazor_App.Shared
{
    public class CookieManager
    {
        ...
        public static void PushCookies(LanguageType  language, string serialized, string message, string githubFileUrl)
        {
            if (serialized.IsValidString() == false)
                return;
            var cookieInfo = CookUpServices.GetExtractGithubInfo(githubFileUrl, InitCookie().Trim());
